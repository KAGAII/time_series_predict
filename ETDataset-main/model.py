...
class TimeSeriesForcasting(pl.LightningModule):
    ...
    def validation_step(self, batch, loss):
        src, trg_in, trg_out = batch
...
if __name__ == "__main__":
    ...
    source = torch.rand(size=(32, 16, 7))
    target_in = torch.rand(size=(32, 96, 7))
    target_out = torch.rand(size=(32, 96, 7))

    ts = TimeSeriesForcasting(n_encoder_inputs=7, n_decoder_inputs=7)
